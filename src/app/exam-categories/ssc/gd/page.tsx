      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-4 py-16 bg-gradient-to-br from-red-50 via-white to-blue-50 overflow-hidden">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              { number: "25,000+", label: "Total Vacancies", icon: "💼" },
              { number: "Medium", label: "Difficulty Level", icon: "📊" },
              { number: "4 Stages", label: "Selection Process", icon: "📋" },
              { number: "₹21,700 - ₹69,100", label: "Salary Range", icon: "💰" },
            ].map((stat, index) => (
