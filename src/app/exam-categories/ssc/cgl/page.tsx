  ...
  const importantTopics = [
    {
      ...
      topics: ["Number System", "Algebra", "Geometry", "Trigonometry", "Statistics", "Data Interpretation"],
      weightage: "25%",
      difficulty: "High"
    },
    {
    ...
    },
    {
      ...
      topics: ["Reading Comprehension", "Grammar", "Vocabulary", "Synonyms & Antonyms", "Idioms & Phrases"],
      weightage: "25%",
      difficulty: "Medium"
    },
    {
  ...
  const preparationTips = [
    {
      ...
      description: "Allocate specific time slots for each subject based on your strengths and weaknesses"
    },
    {
      icon: "📊",
      title: "Regular Mock Tests",
      description: "Take at least 2-3 mock tests weekly to improve speed and accuracy"
    },
    {
      icon: "📖",
      title: "Focus on Basics",
      description: "Build strong fundamentals in mathematics and reasoning before moving to advanced topics"
    },
    {
      icon: "⏰",
      title: "Time Management",
      description: "Practice solving questions within time limits to improve exam performance"
    }
  ];
      ...
      <section className="py-4 px-4 bg-gray-50 border-b">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>›</span>
            <span className="text-blue-600 font-semibold">SSC CGL</span>
          </nav>
        </div>
      </section>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-4 py-16 bg-gradient-to-br from-blue-50 via-white to-indigo-50 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-soft border border-blue-200/50 mb-8">
            ...
            <span className="text-sm font-semibold text-gray-700">SSC Combined Graduate Level</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
            {examDetails.description}. Get comprehensive preparation with our expert-designed study materials, mock tests, and practice papers.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Jump directly to what you need for your SSC CGL preparation
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The SSC CGL exam is conducted in 2 tiers to assess candidates comprehensively
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border-l-4 border-blue-500">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Tier 1 (Prelims)</h3>
                  <p className="text-gray-600">Computer Based Examination</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  <span className="text-blue-600 font-semibold">60 minutes</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="text-red-500 font-semibold">0.50 marks</span>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-blue-50 px-3 py-2 rounded-lg text-sm">
                    ...
                    <div className="text-xs text-gray-600">25 Questions</div>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border-l-4 border-green-500">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Tier 2 (Mains)</h3>
                  <p className="text-gray-600">Computer Based Examination</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="font-medium text-gray-700">Duration</span>
                  <span className="text-green-600 font-semibold">2 hours per paper</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="font-medium text-gray-700">Papers</span>
                  <span className="text-green-600 font-semibold">4 Papers</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <div className="mt-6">
                <h4 className="font-semibold text-gray-900 mb-3">Papers:</h4>
                <div className="space-y-2">
                  <div className="bg-blue-50 px-3 py-2 rounded-lg text-sm">
                    <span className="font-medium">Paper I: Quantitative Abilities</span>
                    <div className="text-xs text-gray-600">100 Questions, 200 Marks</div>
                  </div>
                  <div className="bg-green-50 px-3 py-2 rounded-lg text-sm">
                    <span className="font-medium">Paper II: English Language</span>
                    <div className="text-xs text-gray-600">200 Questions, 200 Marks</div>
                  </div>
                  <div className="bg-purple-50 px-3 py-2 rounded-lg text-sm">
                    <span className="font-medium">Paper III: Statistics</span>
                    <div className="text-xs text-gray-600">100 Questions, 200 Marks</div>
                  </div>
                  <div className="bg-orange-50 px-3 py-2 rounded-lg text-sm">
                    <span className="font-medium">Paper IV: General Studies</span>
                    <div className="text-xs text-gray-600">100 Questions, 200 Marks</div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-8 text-center">
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 inline-block">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> Paper III & IV are for specific posts only. All candidates must appear for Paper I & II.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Follow these expert tips to crack SSC CGL with confidence
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Crack <span className="text-yellow-300">SSC CGL?</span>
          </h2>
